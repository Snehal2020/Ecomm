...
const registerController=async (req, res) => {
    ...
    try {
        ...
        var userd = new User({name, email, phone, address, password, cpassword})
        ...
        if(!userdata){
           ...
           return res.send({message:"User not found"})
            ...
            if(!isMathch)
            {
                ...
                res.status(200).send({success:true,message:"login is successful",token:token,user:userdata,role:userdata.role})
            }
        }
...
module.exports ={getalluserController,getAllOrdersController,orderStatusController,getOrdersController,registerController,loginController,updateProfileController};